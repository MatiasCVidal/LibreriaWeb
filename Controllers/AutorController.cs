    ...
    public class AutorController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Autor != null ? 
                          ...
                          Problem("Entity set 'LibreriaDbContext.Autor'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("AutorId,AutorNombre,AutorApellido")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AutorId,AutorNombre,AutorApellido")] Autor autor)
        {
            if (id != autor.AutorId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LibreriaDbContext.Autor'  is null.");
            }
            var autor = await _context.Autor.FindAsync(id);
            if (autor != null)
            {
